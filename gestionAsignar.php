...
include('modals/md_eliminarOrden.php')
?>
      <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="gestionOrdenTerminada.php"> &nbsp;&nbsp;Ordenes completadas</a>
                                </li>
                            </ul>
                        </li>
                        <li>
 ...
 <div class='col-xs-6'>  
    ...
    <div class="col-xs-12">
    <div id="loadAsignar" class="text-center"> <img src="loader.gif"></div>
...
<script>
    function load(page){
        ...
        $("#loadAsignar").fadeIn('slow');
        $.ajax({
            url:'consulta/cargarAsignar.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loadAsignar").html("<img src='imagenes/loader.gif'>");
            },
