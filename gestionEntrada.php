...
?>
 ...
 <div class='col-xs-6'>  
    ...
    <div class='col-xs-6'>
      <h3 class='text-right'>   
         <button type="button" class="btn btn-tema btn-sm" data-toggle="modal" data-target="#entradaTramite" >
            Entrada de material
          </button>
    ...
    <div class="col-xs-12">
    <div id="loadEntrada" class="text-center"> <img src="loader.gif"></div>
