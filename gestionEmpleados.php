...
?>
    ...
    <div class='col-xs-6'>
      <h3 class='text-right'>   
        <button type="button" class="btn btn-tema btn-sm" data-toggle="modal" data-target="#registroEmpleado" >
            Nuevo Empleado
          </button>
      </h3>
    </div>  
    ...
    <div class="col-xs-12">
    <div id="loadEmpleado" class="text-center"> <img src="loader.gif"></div>
