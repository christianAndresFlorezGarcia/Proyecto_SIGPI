...
?>
 ...
 <div class='col-xs-6'>  
    ...
    <div class="col-xs-12">
    <div id="loadDevolucion" class="text-center"> <img src="loader.gif"></div>
...
<script>
    function load(page){
        ...
        $("#loadDevolucion").fadeIn('slow');
        $.ajax({
            url:'consulta/cargarDevolucion.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loadDevolucion").html("<img src='imagenes/loader.gif'>");
            },
